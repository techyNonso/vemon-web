        ...
        <div className="row align-items-center">
          <div className="col-12 col-md-12 col-lg-6 col-xl-5">
            ...
            <p className="lead mb-5">
              ...
              products to help both small and big business grow. It was started
          ...
          <div
            className="col-12 col-md-8 m-auto ml-lg-auto mr-lg-0 col-lg-6 pt-5 pt-lg-0"
          >
          ...
          <div className="col-12 col-lg-6 col-xl-5 ml-sm-auto pt-5 pt-lg-0">
            ...
            <div className="row pt-3">
              <div className="col-12 col-sm-6 col-xl-5">
                ...
                <p>
                  With our higly trained professionals and project advisers, we
                  are bound to give you a standard like no other.
                </p>
              </div>
              <div className="col-12 col-sm-6 col-xl-5 m-auto pt-3 pt-sm-0">
                ...
                <p>
                  ...
                  properly analyse all your data in toher to provide the best of
                  service to you.
                </p>
              </div>
            </div>
      ...
      <div className="container">
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-auto mt-4 mt-sm-0">
            <a className="btn myBtn" href="https://www.froala.com">Download</a>
          </div>
        </div>
      </div>
    </section>
